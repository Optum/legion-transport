...
require 'spec_helper'
require 'legion/transport/queues/node_status'

RSpec.describe Legion::Transport::Queues::NodeStatus do
  it 'is a class' do
  ...
  it 'is defined under Legion::Transport::Queues' do
    expect(described_class.name).to eq 'Legion::Transport::Queues::NodeStatus'
  end

  it 'returns the correct queue name' do
    instance = described_class.allocate
    expect(instance.queue_name).to eq 'node.status'
  end
