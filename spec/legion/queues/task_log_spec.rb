...
require 'spec_helper'
require 'legion/transport/queues/task_log'

RSpec.describe Legion::Transport::Queues::TaskLog do
  it 'is a class' do
  ...
  it 'is defined under Legion::Transport::Queues' do
    expect(described_class.name).to eq 'Legion::Transport::Queues::TaskLog'
  end

  it 'returns the correct queue name' do
    instance = described_class.allocate
    expect(instance.queue_name).to eq 'task.log'
  end
