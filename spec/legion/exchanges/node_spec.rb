...
RSpec.describe Legion::Transport::Exchanges::Node do
  it 'is a class' do
  ...
  it 'is defined under Legion::Transport::Exchanges' do
    expect(described_class.name).to eq 'Legion::Transport::Exchanges::Node'
  end

  it 'returns the correct exchange name' do
    instance = described_class.allocate
    expect(instance.exchange_name).to eq 'node'
  end
end
